...
LANGUAGE_CODE = 'unknown'  # Default language code for auto-detection
...
def transcribe_chunk(chunk_path, LANGUAGE_CODE):
...
def process_audio_file(audio_path, language=LANGUAGE_CODE):
    y, sr = librosa.load(audio_path, sr=None)
